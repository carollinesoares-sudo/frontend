...
sequenceDiagram
     ...
     Modell ->> Controller: retorno
     Controller ->> View: atualizar inteface

```

### 5.4 Diagrama de Atividades

Diagrama de Atividades: Fluxo de atividades para realização de uma funcionalidade especifica
...
| - |- |- | - |
| 1.0.0| 2026-04-14| DiogoTB | Versão Inicial |
